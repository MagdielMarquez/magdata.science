      ...
      <div className="bg-white shadow-md px-8 py-6 mb-4">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="bg-orange-400 text-white border font-bold border-solid hover:border-orange-400 hover:text-orange-400 hover:bg-white py-2 px-4 tracking-wide focus:outline-none"
            >
              Enviar
            </button>
          </div>
